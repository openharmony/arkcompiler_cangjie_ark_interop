...
**Function:** Displays the custom dialog content. Can be used multiple times, but if the dialog is in SubWindow mode, it cannot display another SubWindow dialog.
...
**Function:** Sets the background fill of the dialog panel.
...
**Function:** Sets the border color of the dialog panel.
...
**Function:** Sets the border style of the dialog panel.
...
**Function:** Sets the border width of the dialog panel.
...
**Function:** Callback when the dialog is closed via the back button, ESC key, or clicking the mask layer.
...
**Function:** Sets the height of the dialog panel.
...
**Function:** The mask layer area of the dialog. Events within the mask layer area are not transmitted, while events outside the mask layer area are transmitted.
...
**Function:** The offset of the dialog relative to the position specified by `alignment`.
...
**Function:** Sets the shadow of the dialog panel.
...
**Function:** Sets the width of the dialog panel.
...
| Parameter | Type | Required | Default Value | Description |
|:---|:---|:---|:---|:---|
| cancel | [VoidCallback](../apis/BasicServicesKit/cj-apis-base.md#type-VoidCallback) | No | { => } | **Named parameter.** Callback when the dialog is closed via the back button, ESC key, or clicking the mask layer. |
| autoCancel | Bool | No | true | **Named parameter.** Whether clicking the mask layer closes the dialog. `true` means the dialog will close. |
...
| maskRect | [Rectangle](./cj-common-types.md#class-rectangle) | No | Rectangle() | **Named parameter.** The mask layer area of the dialog. Events within the mask layer area are not transmitted, while events outside the mask layer area are transmitted.<br/>**Note:**<## Sample Code
