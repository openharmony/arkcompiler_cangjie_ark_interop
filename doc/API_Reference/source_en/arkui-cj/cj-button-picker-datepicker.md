...
**Function:** Creates a sliding date picker within the specified DateTime range.
...
|:----------|:--------------------------------------------------------------------------|:---------|:--------|:------------------------------------------------------------------------------------------------------|
| value     | [PickerTextStyle](#class-pickertextstyle) | Yes      | -       | Text color, font size, and weight for transition items. Initial value:<br>{color: '#ff182431',font: {size: '14fp', weight: FontWeight.Regular}} |
...
| Parameter | Type | Required | Default | Description                                                                 |
|:----------|:------|:---------|:--------|:--------------------------------------------------------------------------|
| value     | Bool  | Yes      | -       | Whether to display the lunar calendar.<br/> - true: Show lunar.<br/> - false: Hide lunar.<br>Default: false. |
...
| Parameter | Type                                                                      | Required | Default | Description                                                                                             |
|:----------|:--------------------------------------------------------------------------|:---------|:--------|:------------------------------------------------------------------------------------------------------|
| value     | [PickerTextStyle](#class-pickertextstyle) | Yes      | -       | Text color, font size, and weight for general items. Initial value:<br>{color: '#ff182431',font: {size: '16fp', weight: FontWeight.Regular}} |
...
| month     | Int64   | Yes      | -       | The month of the selected date (0~11). 0 represents January, 11 represents December. |
