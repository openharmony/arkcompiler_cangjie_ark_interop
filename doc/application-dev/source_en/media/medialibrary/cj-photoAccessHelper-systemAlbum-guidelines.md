...
Use the [getAlbums](../../../../reference/source_en/MediaLibraryKit/cj-apis-file-photo_access_helper.md#func-getalbumsalbumtype-albumsubtype-fetchoptions) interface to obtain the favorites album object.
...
First, [obtain the favorites album object](#obtaining-the-favorites-album-object), then call the [getAssets](../../../../reference/source_en/MediaLibraryKit/cj-apis-file-photo_access_helper.md#func-getassetsfetchoptions) interface to obtain resources from the favorites album.
...
4. Call the [getFirstObject](../../../../reference/source_en/MediaLibraryKit/cj-apis-file-photo_access_helper.md#func-getfirstobject) interface to obtain the first image.
...
Use the [getAlbums](../../../../reference/source_en/MediaLibraryKit/cj-apis-file-photo_access_helper.md#func-getalbumsalbumtype-albumsubtype-fetchoptions) interface to obtain the video album object.
...
First, [obtain the video album object](#obtaining-the-video-album-object), then call the [getAssets](../../../../reference/source_en/MediaLibraryKit/cj-apis-file-photo_access_helper.md#func-getassetsfetchoptions) interface to obtain video resources from the video album.
...
4. Call the [getFirstObject](../../../../reference/source_en/MediaLibraryKit/cj-apis-file-photo_access_helper.md#func-getfirstobject) interface to obtain the first video.
