...
Below are the key interfaces for User Preferences persistence. For more details, refer to [User Preferences](../../../reference/source_en/ArkData/cj-apis-preferences.md).
