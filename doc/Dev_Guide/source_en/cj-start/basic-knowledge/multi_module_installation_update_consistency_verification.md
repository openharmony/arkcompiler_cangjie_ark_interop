...
| appDistributionType | The `app-distribution-type` in the application's [signature certificate](../../../../API_Reference/source_en/apis/AbilityKit/cj-apis-bundle_manager.md#let-appdistributiontype), indicating the distribution type of the application. | Yes | No verification for different versions; verification required for the same version. |
