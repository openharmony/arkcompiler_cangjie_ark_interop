...
3. **Third-level directory `el1/~el5/`**: Represents different file encryption types.
   ...
   >
   > Developers can monitor the [COMMON_EVENT_USER_UNLOCKED](../../../API_Reference/source_en/apis/BasicServicesKit/cj-apis-common_event_manager.md#static-const-common_event_user_unlocked) event to detect when the user completes the first authentication.
