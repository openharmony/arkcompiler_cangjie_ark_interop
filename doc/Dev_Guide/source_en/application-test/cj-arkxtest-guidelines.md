...
UI testing is based on unit testing. UI test scripts extend unit test scripts by adding UiTest interfaces. For details, refer to the [API documentation](../../../API_Reference/source_en/TestKit/cj-apis-ui_test.md).
