...
## 接口关键参数说明
开发者通过调用[startAbility](../../../API_Reference/source_zh_cn/AbilityKit/cj-apis-app-ability.md#func-startabilitywant)接口即可实现由已安装的垂域应用来打开文件。

**表1** startAbility请求中[Want](../../../API_Reference/source_zh_cn/AbilityKit/cj-apis-app-ability.md#class-want)相关参数说明
...
**表2** [parameters](../../../API_Reference/source_zh_cn/AbilityKit/cj-apis-app-ability.md#enum-params)相关参数说明
...
**表3** [flags](../../../API_Reference/source_zh_cn/AbilityKit/cj-apis-app-ability.md#enum-flags)相关参数说明
